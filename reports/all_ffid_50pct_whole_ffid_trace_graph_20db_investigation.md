...
| 19 | 形式: w128 / r12 / batch 4 @10,000 updates | (実行中) | — |
...
**公式基準は未達。** 最良の確定値は stage18 の **10.322 dB**(GNN、
w128/r12/batch4、2,500 updates)であり、厳密 20 dB 基準に対し **9.68 dB 不足**。
実行中の stage19(同構成 10,000 updates)の外挿予測は 11–12 dB であり、
観測されたデータスケーリング(倍化あたり +1.0→+0.4 dB で逓減)の下では、
