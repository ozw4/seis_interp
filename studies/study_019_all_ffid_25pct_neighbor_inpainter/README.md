...
- only train amplitudes enter inputs
...
- threshold shortfall 8.6511 dB; Stage 07 missed the 50,000-step promotion gate by 6.9013 dB
- best run: `20260831T030617Z_05dc7d9_stage07_width512_k274_10000_steps` under `runs/study_019_all_ffid_25pct_neighbor_inpainter/`
...
- Stages 02-05 not promoted; width 512 promoted to the 10,000-update diagnostic; no 50,000-update budget-only extension.
