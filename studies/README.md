...
| [study_034_c3_nersi_baseline](study_034_c3_nersi_baseline/README.md) | `planned` | per-volume observed-only profile-wise NeRSI repository reimplementation / fixed QC validation | How well do four predeclared NeRSI capacity and learning-rate candidates interpolate the fixed validation case, and how does their internal-learning regime differ from pretrained frozen GNN inference? |
