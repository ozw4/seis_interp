...
| [study_032_c3_proposed_gnn_10db](study_032_c3_proposed_gnn_10db/README.md) | `final_5000_adopted_10db_achieved` — final 11.9354 dB; saved-output and CPU audits passed | QC train-partition proposed relational GNN / fixed full validation | No fixed shear; observed trace RMS, interpolated gain and trace-relative training loss. See the [final evaluation](../reports/c3_proposed_gnn_relative_mse_5k_20260909.md). |
